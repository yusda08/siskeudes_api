...
class M_Rab extends Model
{
    ...
    public final function getTaRab($tahun, $kd_kec = null)
    {
        ...
        return $this->dbSiskeudes->query("SELECT a.*, b.Nama_Obyek FROM Ta_Rab a 
    JOIN Ref_Rek4 b ON a.Kd_Rincian=b.Obyek 
    WHERE Tahun=$tahun and SUBSTRING(a.Kd_Rincian,1,1)='5' {$where}");
    }
